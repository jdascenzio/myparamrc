...
alias cross-make-atlas='ARCH=arm CROSS_COMPILE=/media/data/projet/atlas/atlas_master_project/buildroot/output/host/usr/bin/arm-buildroot-linux-gnueabihf- make'
...
alias cross-qmake-atlas='/media/data/projet/atlas/atlas_master_project/buildroot/output/host/usr/bin/qmake -r -spec /media/data/projet/atlas/atlas_master_project/buildroot/output/host/mkspecs/devices/linux-buildroot-g++'
alias win-qmake='/home/julien/mnt/misc/mxe/usr/i686-w64-mingw32.static/qt5/bin/qmake'
ATLAS_PATH=/media/data/projet/atlas/atlas_master_project/
